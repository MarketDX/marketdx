...
_INSTRUCTIONS = (
    ...
    "Fed→rates, US-China tariffs→trade): it IS a MarketDX question, NOT a web search — our 2026 news carries "
    ...
    "one. Do NOT default to a web search just because the subject reads as 'geopolitics / current events' — "
    "web only supplements a specific detail MarketDX genuinely lacks, and when you do, SAY which came from "
    "which. 🔵 But if the subject is a SECTOR / INDUSTRY / THEME "
